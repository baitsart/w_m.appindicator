...
echo "Number of images $total_files"
	then
...
exit
	...
	if [ $? -eq 0 ]; then
notify-send -i /usr/share/icons/gnome/32x32/apps/preferences-desktop-wallpaper.png "w-m" "No picture:  /backgrounds/favoritos"
     exit 0
fi
