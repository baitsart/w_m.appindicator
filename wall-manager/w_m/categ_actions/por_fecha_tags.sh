...
case $? in
         0)
		cat /tmp/tags-dated | grep -n "$age" | cut -d':' -f1 > /tmp/temporal-line-numbers
sed -i '/^$/d' /tmp/temporal-line-numbers
cat /tmp/temporal-line-numbers | while read line ; do linea=$(echo $line); sed ''$linea'!d' /tmp/tags-dated | cat >> /tmp/temporal-line-numbers1; done
comands
exit;;
         1)
                exit 1;;
...
case $? in
         0)
		cat /tmp/tags-dated | cut -c 7-8 | grep -n "$age" | cut -d':' -f1 > /tmp/temporal-line-numbers
sed -i '/^$/d' /tmp/temporal-line-numbers
cat /tmp/temporal-line-numbers | while read line ; do linea=$(echo $line); sed ''$linea'!d' /tmp/tags-dated | cat >> /tmp/temporal-line-numbers1; done
comands
exit;;
...
case $? in
         0)
		cat /tmp/tags-dated | cut -c 4-8 | grep -n "$age" | cut -d':' -f1 > /tmp/temporal-line-numbers
sed -i '/^$/d' /tmp/temporal-line-numbers
cat /tmp/temporal-line-numbers | while read line ; do linea=$(echo $line); sed ''$linea'!d' /tmp/tags-dated | cat >> /tmp/temporal-line-numbers1; done
comands
exit;;
...
then
sed -i 's|'"$file"'||' /tmp/tags-dated
sed -i '/^$/d' /tmp/tags-dated
